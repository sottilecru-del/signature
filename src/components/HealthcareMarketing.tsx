    ...
    <div className="bg-neutral-50">
      ...
      <div className="bg-white border-b border-neutral-200 py-2 px-4 md:px-8">
        <div className="max-w-screen-2xl mx-auto text-[10px] md:text-xs text-neutral-400 flex items-center gap-2">
          ...
          <span>›</span>
          <span className="font-medium text-neutral-600">Digital Marketing for Healthcare & Dental</span>
        </div>
      </div>
        ...
        <div className="max-w-screen-2xl mx-auto grid lg:grid-cols-[1fr_350px] gap-12 items-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-orange-500/20 border border-orange-500/40 text-orange-200 text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full mb-6">
              ...
              Healthcare Marketing Experts for USA, UK & Australia
            </div>
            <h1 className="font-condensed text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">
              Digital Marketing for Healthcare & Dental That <span className="text-orange-400">Fills Your Appointment Book</span>
            </h1>
            <p className="text-lg text-white/80 mb-8 max-w-2xl leading-relaxed">
              We help medical clinics and dental practices dominate local search, generate patient leads, and automate appointment bookings. Specialized SEO, PPC, and reputation management for healthcare.
            </p>
            
            <div className="flex flex-wrap gap-2 mb-8">
              {['Medical SEO', 'Local GMB', 'Patient PPC', 'Content Marketing', 'Reputation Mgmt', 'Appt Automation'].map((pill, i) => (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { num: '50%+', label: 'Avg Patient Increase' },
                { num: '60+', label: 'Clinics Managed' },
                { num: '40%+', label: 'Lower Cost Per Patient' },
          ...
          >
            <div className="bg-[#FF6B00] py-3 px-6 text-center">
              <h3 className="text-white font-bold text-sm">Free Clinic Marketing Audit</h3>
            ...
            <div className="p-6">
              {!submitted ? (
                <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="space-y-3">
                  ...
                  <input type="text" placeholder="Clinic Name *" required className="w-full border border-neutral-200 rounded px-3 py-2 text-sm outline-none focus:border-[#1B3A6B]" />
                  ...
                  <button type="submit" className="w-full bg-[#1B3A6B] text-white py-3 rounded font-bold text-sm hover:bg-[#152d55] transition-colors flex items-center justify-center gap-2">
                    <BarChart3 size={16} /> Get My Free Clinic Audit
                  </button>
                </form>
              ) : (
        ...
        <div className="space-y-12">
          ...
          <section className="bg-white p-8 rounded-lg border border-neutral-200 shadow-sm">
            ...
            <h2 className="font-condensed text-2xl font-bold text-[#1B3A6B] mb-6 border-l-4 border-orange-500 pl-4">
              Specialized Marketing for Healthcare
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { 
                  icon: <Search size={24} />, 
                  title: 'Medical SEO', 
                  desc: 'We optimize your clinic\'s website to rank for high-intent medical keywords, ensuring you are the first choice for potential patients.' 
                },
                { 
                  icon: <Stethoscope size={24} />, 
                  title: 'Local GMB for Clinics', 
                  desc: 'We dominate the local 3-pack for your medical specialties, making your clinic visible to patients in your immediate vicinity.' 
                },
                { 
                  icon: <Target size={24} />, 
                  title: 'Patient-Focused PPC', 
                  desc: 'We run targeted Google Ads campaigns that capture patients at the exact moment they are searching for medical help.' 
                },
                { 
                  icon: <FileText size={24} />, 
                  title: 'Healthcare Content Marketing', 
                  desc: 'We create authoritative blog posts and guides that build trust and establish your clinic as a thought leader in your field.' 
                },
                { 
                  icon: <Star size={24} />, 
                  title: 'Reputation Management', 
                  desc: 'We help you generate and manage positive reviews, ensuring your clinic has a stellar online reputation.' 
                },
                { 
                  icon: <Calendar size={24} />, 
                  title: 'Appointment Automation', 
                  desc: 'We automate your appointment booking process, ensuring no patient is missed and every potential patient is followed up with instantly.' 
                }
              ].map((item, i) => (
          ...
          {/* Pricing Section */}
          <section id="pricing-health" className="bg-white p-8 rounded-lg border border-neutral-200 shadow-sm">
            <div className="flex items-center gap-2 text-orange-500 text-[10px] font-bold uppercase tracking-widest mb-2">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              {[
                ...
                { 
                  ...
                  sub: 'per month',
                  featured: true, 
                  features: ['Everything in Starter', 'Google Ads management', '4 blog posts/mo', 'Appt automation', 'Competitor tracking', 'Priority support'] 
                },
                { 
                  title: 'Scale', 
                  price: '$2,999', 
          ...
          {/* FAQ Section */}
          <section id="faq-health" className="bg-white p-8 rounded-lg border border-neutral-200 shadow-sm">
            <div className="flex items-center gap-2 text-orange-500 text-[10px] font-bold uppercase tracking-widest mb-2">
            ...
            <div className="space-y-4">
              <FAQItem 
                question="Why do healthcare clinics need specialized marketing?"
                answer="Healthcare marketing is highly competitive and regulated. Specialized marketing ensures your clinic ranks for high-intent keywords while staying compliant with medical advertising rules."
              />
              <FAQItem 
                question="How long until we see more patients?"
                answer="Most clinics see an increase in high-quality patient leads within 2-4 months of consistent SEO and PPC optimization."
              />
              <FAQItem 
                question="Do you help with appointment booking?"
                answer="Yes, we automate the booking process to ensure every patient is captured and followed up with instantly, increasing your lead-to-patient conversion rate."
              />
              <FAQItem 
                question="Can you manage our Google Ads?"
                answer="Yes, we specialize in high-intent medical PPC, ensuring your ads appear for the most relevant and valuable search queries."
              />
            </div>
          </section>
        </div>
        ...
        <aside className="sidebar space-y-6">
          <div className="card border-t-4 border-t-[#1B3A6B] sticky top-24">
            <div className="bg-[#1B3A6B] p-4 text-white">
              <h3 className="font-bold text-sm">Free Clinic Audit</h3>
              <p className="text-[10px] text-white/70 uppercase tracking-widest">Score your clinic in 48 hours</p>
            </div>
            <div className="p-5">
              {!sidebarSubmitted ? (
